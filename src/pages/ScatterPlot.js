...
//   const dataToShowOnScreen = timeFilteredData ? timeFilteredData : currentData;

//   React.useEffect(() => console.log("TO SHOW", dataToShowOnScreen), [dataToShowOnScreen])
...
//   React.useEffect(() => console.log("timeFilteredData", timeFilteredData), [
//     timeFilteredData
//   ]);
...
//       <div style={{ display: "flex" }}>
//         <div ref={svgContainer}></div>
//         <TimeFilters changeTimeFilteredData={changeTimeFilteredData} />
//       </div>
//       <MouseTooltip
//         visible={isTooltipVisible}
//         offsetX={-45}
