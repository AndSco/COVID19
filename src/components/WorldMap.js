...
const WorldMap = props => {
  ...
  return (
    <div id="chart-container">
      ...
      {/* <h4 id="map-label">{dataParameter}</h4> */}
    </div>
  );
};
...
//   const totalCases = data.map(
//     entry => entry.properties.data[dataParameter]
//   );
//   const minCases = d3.min(totalCases);
//   const maxCases = d3.max(totalCases);
...
//         };
//       }, {});
//     filteredData.Country = geographies[countryIndex].properties.name;
//     changeSummaryData(filteredData);
//   };
...
//               <circle
//                 key={`marker-${i}`}
//                 cx={projection(state.properties.data.coordinates)[0]}
//                 cy={projection(state.properties.data.coordinates)[1]}
//                 r={state.properties.data["Total cases"] / 1200}
//                 style={{ opacity: 0.6 }}
//                 fill="#E91E63"
//                 stroke="#FFFFFF"
//                 className="marker"
